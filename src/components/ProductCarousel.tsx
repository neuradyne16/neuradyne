                    ...
                    <CardContent className="flex w-full h-full flex-col md:flex-row gap-0 p-0">
                      ...
                      <div className={`flex flex-col justify-center gap-3 sm:gap-4 p-5 sm:p-6 md:p-10 ${service.image ? 'w-full md:w-1/2' : 'w-full'}`}>
                        <div className="space-y-3 sm:space-y-4">
                          ...
                          {service.techStack && (
                            <div className="mt-2 sm:mt-4 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                              <div className="text-xs sm:text-sm md:text-base">
                                <span className="font-semibold text-gray-900 dark:text-white">Tech Stack:&nbsp;</span>
                                <span className="text-gray-700 dark:text-gray-300">{service.techStack}</span>
                              </div>
                            </div>
                          )}
                        </div>
