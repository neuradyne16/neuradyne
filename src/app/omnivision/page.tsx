...
const CameraIcon = () => (
  <svg
    className="w-16 h-16 mx-auto mb-4 text-sky-700 dark:text-blue-400"
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
  >
...
const ArrowIcon = () => (
  <svg
    className="w-8 h-8 text-sky-400 dark:text-blue-300"
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
  >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="text-4xl font-bold">
                        {config.problem.liveToll.deaths}
                      </div>
                      <div className="text-sm">Deaths</div>
                    </div>
                    <div>
                      <div className="text-4xl font-bold">
                        {config.problem.liveToll.injuries}
                      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {config.cta.getInTouch.enabled && (
              ...
              >
                ...
                <p className="text-sky-800 dark:text-gray-300 mb-2">
                  {config.cta.getInTouch.subtitle}
                </p>
                <p className="text-sm text-sky-700 dark:text-gray-400 mb-6">
                  {config.cta.getInTouch.contactText}
                </p>
                <Link
            ...
            {config.cta.requestDemo.enabled && (
              ...
              >
                ...
                <p className="text-sky-800 dark:text-gray-300 mb-2">
                  {config.cta.requestDemo.subtitle}
                </p>
                <p className="text-sm text-sky-700 dark:text-gray-400 mb-6">
                  {config.cta.requestDemo.demoText}
                </p>
                <Link
